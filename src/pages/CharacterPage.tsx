        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center flex flex-col items-center gap-4">
            <button onClick={() => setArOpen(true)} className="btn-primary inline-flex"
              ...
              Оживить {char.name === "Енофья" ? "Енофью" : char.name === "Тыдочка" ? "Тыдочку" : char.slug === "enira" ? "Ениру с Тыдочкой" : char.name + "а"} в AR
            </button>
            <a href="/shop" className="btn-primary inline-flex">
              <Icon name="ShoppingCart" size={18} />
              Купить статуэтку {char.name === "Енофья" ? "Енофьи" : char.name === "Тыдочка" ? "Тыдочки" : char.slug === "enira" ? "Ениры с Тыдочкой" : char.name + "а"}
            </a>
          </div>
