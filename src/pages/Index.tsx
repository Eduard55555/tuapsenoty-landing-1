...
const characters = [
  {
    name: "Туапсеныч-Старший",
    emoji: "🌕",
    role: "Патриарх рода, основатель",
    description: "Седой енот с тростью из корня самшита и глазами цвета лазури. Родился у Священного Родника Мечты в лунном мареве. Столетиями стоит щитом перед побережьем.",
    ritual: "Коснись Лунного посоха — туманы рассеются, путь станет ясным",
    location: "Родник Мечты, Дедеркой",
  ...
  },
  {
    ...
    description: "Пухлая матронья в переднике из водорослей. Хранит Ключ от Енотовой пещеры и помнит все предания Черноморья от начала времён.",
    ritual: "Погладь передник — дом наполнится теплом и достатком",
    location: "Дуб у «Зелёного Гая»",
    color: "from-rose-100 to-orange-100",
  },
  {
    name: "Моряныч",
    emoji: "⭐",
    role: "Повелитель приливов",
    description: "На лбу — татуировка из перламутровых чешуек. Ныряет за падающими звёздами у Кадошской бухты и торгует ими на раковины с жемчугом.",
    ritual: "Подержи Звёздную монетку — вечная любовь от Черноморья",
    location: "Маяк Кадош",
  ...
  },
  {
    name: "Туапсеня",
    emoji: "🐚",
    role: "Морская сирота, плетельщица",
    description: "Вынесена штормом из подводного чертога. Бирюзовые глаза, шубка из солёного тумана. Говорит с дельфинами и предсказывает приливы по танцу крабов.",
    ritual: "Прижми Ракушковый оберег к уху — услышишь своё желание",
    location: "Голубая бухта",
  ...
  },
  {
    ...
    description: "Тощий акробат, взлетает по скалам Индюка за орлиными яйцами. Крадёт блестяшки с палубы яхт и оставляет на песке карты к тайнам.",
    ritual: "Разверни Карту сокровищ — найдёшь, что давно потерял",
    location: "Скалы Индюка",
  ...
  },
  {
    ...
    description: "Толстячок, выуживает из глубин сокровища затонувших лодок — ржавые якоря, потерянные кольца, бутылки с посланиями. Хранитель Енотовой Сокровищницы.",
    ritual: "Потри Морскую жемчужину — богатство само найдёт тебя",
    location: "Пляж у санатория",
    color: "from-sky-100 to-indigo-100",
  },
  {
    name: "Морской Волчонок",
    emoji: "⚓",
    role: "Приёмный сын, таинственный странник",
    description: "Найден после шторма 1873 года у Кадоша, обмотанный рыболовной сетью. Шрам через морду, плащ из сети. Знает все пути затонувших кораблей.",
    ritual: "Коснись Компаса из якоря — он укажет путь к твоему кладу",
    location: "Якорная скала",
      ...
      <section id="about" className="py-20 sm:py-28 px-4 sm:px-6" style={{ backgroundColor: "var(--cream)" }}>
        <div className="max-w-6xl mx-auto">
            ...
            {[
              {
                emoji: "😔",
                title: "Проблема",
                text: "Туапсе — транзитный город. Туристы едут в Сочи и Геленджик, не замечая жемчужину у моря с удивительной историей.",
              },
              {
                emoji: "✨",
                title: "Решение",
                text: "Семья из 8 бронзовых енотов-хранителей с ритуалами, легендами и характерами. Каждый — точка притяжения на карте города.",
              },
              {
                emoji: "🏆",
                title: "Уже сделано",
          ...
          <div className="mt-16 rounded-3xl overflow-hidden shadow-2xl relative">
            <img
              src="https://cdn.poehali.dev/projects/5c864877-cf84-4a78-897d-bd1766f6ada6/bucket/050bd85e-b6ca-4e18-8aad-ac00640f7e1a.jpg"
