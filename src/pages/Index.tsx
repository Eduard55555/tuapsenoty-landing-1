...
const characters = [
  {
    ...
    emoji: "🎣",
    role: "Рыбак-философ",
    description: "Старший хранитель набережной. Сидит с удочкой и мудрыми мыслями о море.",
    ritual: "Потри нос — к удаче на рыбалке",
    location: "Набережная",
  ...
  },
  {
    name: "Енофья",
    emoji: "🌺",
    role: "Хранительница цветов",
    description: "Собирает целебные травы и дарит прохожим маленькие букетики счастья.",
    ritual: "Прикоснись к корзинке — к здоровью",
    location: "Парк",
  ...
  },
  {
    name: "Туапсей",
    emoji: "⚓",
    role: "Морской капитан",
    description: "Хранит историю порта. Знает каждый корабль, зашедший в бухту.",
    ritual: "Загадай желание и подержись за якорь",
    location: "Порт",
  ...
  },
  {
    ...
    description: "Читает книги о Туапсе и рассказывает истории каждому, кто присядет рядом.",
    ritual: "Открой книгу на любой странице — получишь знак",
    location: "Парк",
  ...
  },
  {
    ...
    emoji: "🎨",
    role: "Художник",
    description: "Рисует закаты над морем. Его этюдник всегда открыт для новых красок.",
    ritual: "Прикоснись к кисти — и твой день станет ярче",
    location: "Набережная",
  ...
  },
  {
    ...
    emoji: "🍉",
    role: "Лакомка",
    description: "Охраняет рынок и дружит с торговцами. Угощает арбузом всех гостей города.",
    ritual: "Потри животик — к сытости и достатку",
    location: "Рынок",
  ...
  },
  {
    ...
    emoji: "🚂",
    role: "Путешественник",
    description: "Встречает и провожает гостей на вокзале. Знает, как найти дорогу домой.",
    ritual: "Помаши лапой — поезд придёт вовремя",
    location: "Вокзал",
  ...
  },
  {
    ...
    emoji: "🌊",
    role: "Дитя волны",
    description: "Самая маленькая из семьи. Купается в море в любую погоду и смеётся над волнами.",
    ritual: "Опусти ладонь в воду рядом — море пошлёт удачу",
    location: "Пляж",
