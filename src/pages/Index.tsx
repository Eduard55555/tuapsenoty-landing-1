    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--cream)" }}>
      ...
      <section id="about" className="py-20 sm:py-28 px-4 sm:px-6" style={{ backgroundColor: "var(--cream)" }}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="font-body text-lg w-full mb-16 space-y-5" style={{ color: "#6B4C35", lineHeight: 1.9, textAlign: "justify" }}>
            ...
            <p style={{ fontStyle: "italic", fontWeight: 600 }}>Туапсе заслужил свою легенду. Мы её создаём. А вы — её начало.</p>
          </div>
