...
const PRODUCTS = [
  ...
  },
  {
    ...
    description: "Это не сувенир. Это маленькое бронзовое произведение искусства.\n\nТочная копия городского хранителя. Отлита из бронзы, прошла патинирование и финишную обработку вручную.\n\n• Настоящая бронза, устойчивая к времени\n• Ручная работа под контролем автора\n• Ограниченный выпуск\n• Размер: 20 см\n\nВ комплекте: сертификат подлинности + мини-фигурки всей семьи Туапсенотов.",
    badge: "Эксклюзив",
    badgeColor: "#B8732F",
  },
  {
    ...
    description: "Это не сувенир. Это маленькое бронзовое произведение искусства.\n\nТочная копия городской хранительницы. Отлита из бронзы, прошла патинирование и финишную обработку вручную.\n\n• Настоящая бронза, устойчивая к времени\n• Ручная работа под контролем автора\n• Ограниченный выпуск\n• Размер: 20 см\n\nВ комплекте: сертификат подлинности + мини-фигурки всей семьи Туапсенотов.",
    badge: "Эксклюзив",
    badgeColor: "#B8732F",
  },
];
