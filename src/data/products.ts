...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 1000,
    emoji: "🦝",
    image: "/opt/6c1b2819-39be-47db-977d-1d2258e05633.webp",
    images: [
      "/opt/6c1b2819-39be-47db-977d-1d2258e05633.webp",
      "/opt/b1ac2392-4ae8-4f56-88c6-1b884132db1f.webp",
      "/opt/6b86eb0a-a5a8-4eed-aa37-31d53a1c7cac.webp",
      "/opt/0c0350f2-4ec7-4b79-abff-3cb74ec54a7e.webp",
    ],
  ...
  },
  {
    ...
    price: 1000,
    emoji: "🐚",
    image: "/opt/5421ef3e-bd49-4f95-8e80-ed373b77948a.webp",
    images: [
      "/opt/5421ef3e-bd49-4f95-8e80-ed373b77948a.webp",
      "/opt/af89e834-9cde-43c4-8bdf-4412ef6a9362.webp",
      "/opt/d3885ac9-b8c0-4982-9e04-f1504eb59670.webp",
    ],
  ...
  },
  {
    ...
    price: 1000,
    emoji: "🦝",
    image: "/opt/08352612-7bdb-486a-a022-edd8ca2aa42c.webp",
    description: "Частичка Туапсе для дома\n\nБронзовый хранитель, который принесёт тепло и уют в ваш дом. Ручная работа, приятный вес, благородный блеск «под бронзу».",
    badge: "Новинка",
    badgeColor: "#4CAF50",
  },
